...
docker tag $REGISTRY/platform:4.0-centos-adoptium-17 $REGISTRY/platform:4.0-latest
docker rmi $REGISTRY/platform:4.0-centos-adoptium-17
...
docker tag $REGISTRY/platform:4.0-light-centos-adoptium-17 $REGISTRY/platform:4.0-latest-light
docker rmi $REGISTRY/platform:4.0-light-centos-adoptium-17
