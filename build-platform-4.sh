...
docker tag $REGISTRY/platform:4.0-almalinux9-17 $REGISTRY/platform:4.0-latest
docker rmi $REGISTRY/platform:4.0-almalinux9-17
...
docker tag $REGISTRY/platform:4.0-light-almalinux9-17 $REGISTRY/platform:4.0-latest-light
docker rmi $REGISTRY/platform:4.0-light-almalinux9-17
